local gso_menu = MenuElement({id = "GSOMenu", name = "GamsteronOrb", type = MENU})
        gso_menu:MenuElement({id = "gso_ewin", name = "Lower Value = Faster KITE", value = 200, min = 100, max = 300, step = 25 })
        gso_menu:MenuElement({id = "gso_lcs", name = "Higher Value = Faster Last Hit React", value = 100, min = 0, max = 200, step = 25 })
        gso_menu:MenuElement({id = "gso_hum", name = "Humanizer Movement Delay", value = 225, min = 150, max = 300, step = 25 })
