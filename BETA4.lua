                ...
                if gso_combo then
                        ...
                        for i = 1, Game.HeroCount() do
                                ...
                                if gso_unit.isEnemy and gso_unit.health > 0 and gso_sqrt((gso_unitpos.x-gso_gso_heroposX)^2 + (gso_unitpos.z-gso_gso_heroposZ)^2) < gso_heroAArange + gso_unit.boundingRadius then
                                        ...
                                        local gso_unithealth  = gso_unit.health * ( armor / ( armor + 100 ) )
                                        if gso_unithealth < gso_num then
                                                gso_num = gso_unithealth
                        ...
                        for i = 1, Game.MinionCount() do
                                ...
                                if gso_unit.isEnemy and gso_unit.handle and gso_unit.health > 0 then
                                        ...
                                        if gso_distance < gso_heroAArange + gso_unit.boundingRadius then
                                                ...
                                                if gso_unitHP < gso_heroAD or gso_unitHP - GetHealthPrediction(gso_unit, gso_aacompleteT) < gso_heroAD then
                                                        gso_AAtarget = gso_unit
                                                        break
                                                elseif gso_unitHP - GetHealthPrediction(gso_unit, gso_aacompleteT + ( 3 * gso_heroanimT ) ) < gso_heroAD then
                                                        gso_AAkillablesoon = gso_unit
                                                        break
                                                elseif gso_unitHP > gso_num then
                                                        gso_num = gso_unitHP
